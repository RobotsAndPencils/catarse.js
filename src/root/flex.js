                            ...
                            m('.fontsize-larger.u-text-center.u-marginbottom-60.u-margintop-40', 'Dúvidas'), m('.w-row.u-marginbottom-60', [
                                m('.w-col.w-col-6', [
                                    m.component(c.landingQA, {
                                        question: 'What are the fees for the Flex modality? ',
                                        answer: 'Adding a project will not cost anything, but similarly to the "all or nothing" modality, Startio will keep 13% of the funding.'
                                    }),
                                    m.component(c.landingQA, {
                                        question: 'Where does the money from my project comes from?',
