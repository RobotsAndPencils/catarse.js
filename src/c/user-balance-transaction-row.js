                                 ...
                                 m('.w-row', [
                                     m('.w-col.w-col-4', [
                                         m('div', [
                                             ...
                                             m.trust('&nbsp;'),
                                             m('span.fontsize-base.text-error', `$ ${h.formatNumber(Math.abs(item.debit), 2, 3)}`)
                                         ])
                                     ]),
                                     m('.w-col.w-col-4', [
                                         m('div', [
                                             ...
                                             m.trust('&nbsp;'),
                                             m('span.fontsize-base.text-success', `$ ${h.formatNumber(item.credit, 2, 3)}`)
                                         ])
                                     ]),
                                     m('.w-col.w-col-4', [
                                         m('div', [
                                             ...
                                             m.trust('&nbsp;'),
                                             m('span.fontsize-base', `$ ${h.formatNumber(item.total_amount, 2, 3)}`)
                                         ])
                                     ])
                                 ])
                             ])
                     ...
                     (ctrl.expanded() ? m('.card', _.map(item.source, (transaction) => {
                         ...
                         return m('div',[
                             m('.w-row.fontsize-small.u-marginbottom-10', [
                                 m('.w-col.w-col-2', [
                                     m(`.text-${(pos ? 'success' : 'error')}`, `${pos ? '+' : '-'} $ ${h.formatNumber(Math.abs(transaction.amount), 2, 3)}`)
                                 ]),
                                 m('.w-col.w-col-10', [
