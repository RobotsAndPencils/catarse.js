        ...
        view: (ctrl, args) => {
            return m('.pop-share', {
                ...
                m('.w-widget.w-widget-facebook.w-hidden-small.w-hidden-tiny.share-block', [
                    m('iframe[allowtransparency="true"][width="150px"][height="22px"][frameborder="0"][scrolling="no"][src="https://www.facebook.com/v2.0/plugins/share_button.php?app_id=173747042661491&channel=https%3A%2F%2Fs-static.ak.facebook.com%2Fconnect%2Fxd_arbiter%2F44OwK74u0Ie.js%3Fversion%3D41%23cb%3Df7d9b900c%26domain%3Dwww.startio-staging.com%26origin%3Dhttps%253A%252F%252Fwww.startio-staging.com%252Ff4b3ad0c8%26relation%3Dparent.parent&container_width=0&href=https%3A%2F%2Fwww.startio-staging.com%2Fpt%2F' + args.project().permalink + '%3Fref%3Dfacebook&layout=button_count&sdk=joey"]')
                ]),
                m('.w-widget.w-widget-twitter.w-hidden-small.w-hidden-tiny.share-block', [
                    m('iframe[allowtransparency="true"][width="120px"][height="22px"][frameborder="0"][scrolling="no"][src="//platform.twitter.com/widgets/tweet_button.8d007ddfc184e6776be76fe9e5e52d69.en.html#_=1442425984936&count=horizontal&dnt=false&id=twitter-widget-1&lang=en&original_referer=https%3A%2F%2Fwww.startio-staging.com%2Fpt%2F' + args.project().permalink + '&size=m&text=Confira%20o%20projeto%20' + args.project().name + '%20no%20%40catarse&type=share&url=https%3A%2F%2Fwww.startio-staging.com%2Fpt%2F' + args.project().permalink + '%3Fref%3Dtwitter&via=startio"]')
                ]),
